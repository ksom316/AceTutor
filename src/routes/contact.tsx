  ...
  head: () => ({
    meta: [
      { title: "Contact Us — AceTutor" },
      {
        name: "description",
        content:
          "Get in touch with the AceTutor team by phone or email — we usually reply within 24 hours.",
      },
    ],
  }),
...
function ContactPage() {
  ...
  // Signed in → render inside the workspace sidebar shell so the contact page
  // shares one navigation with the dashboard. Visitors keep the marketing
  // chrome (floating header + footer).
  if (user) {
    return (
      <AppShell user={user}>
        <ContactContent authed />
      </AppShell>
    );
  }
      ...
      <div className="container mx-auto max-w-6xl px-4 pb-20 pt-10 md:pt-14">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground md:text-lg">
            Have a question, some feedback, or just want to say hi? Reach the AceTutor team through
            any of the numbers or email addresses below — we'd love to hear from you.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1fr_1.6fr]">
          ...
          >
            ...
            <p className="relative mt-2 text-sm text-primary-foreground/85">
              Whether you're a student, lecturer, or just curious about adaptive learning, our door
              is always open.
            </p>
              ...
              <div className="mb-4 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Tap to compose, or copy the address.
                  </p>
                </div>
              </div>
              <motion.div
        ...
        {authed ? (
          ...
          >
            <h2 className="text-2xl font-bold tracking-tight md:text-3xl">Back to learning?</h2>
            <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground md:text-base">
              Jump back into your courses while you wait for our reply.
            </p>
          ...
          >
            ...
            <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground md:text-base">
              Create your free account and let AceTutor adapt to the way you learn — while you wait
              for our reply.
            </p>
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <Button asChild size="lg" className="h-12 rounded-full px-6 text-base">
